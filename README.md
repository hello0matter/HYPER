...
组合首轮结果（20个产品中17个纳入、8年历史最后30%样本外约 +3.75%，年化约 +0.50%，最大回撤约 -4.31%）记录在 [`docs/multi_asset_portfolio_results.md`](docs/multi_asset_portfolio_results.md)。这只是基线，不是收益承诺。
